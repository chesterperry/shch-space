...
Статический сайт [shch.one](https://shch.one): портфолио и архив проектов. Сайт
работает на Astro 7 и собирает Markdown/MDX из отдельной папки Obsidian.
...
Записи остаются в исходном Obsidian-хранилище и версионируемом снимке, но
публичные маршруты блокнота и магазина отключены.
